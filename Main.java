    ...
    if (wakeupChoice == 1) {
      ...
      if (parkChoice == 1) {
        ...
        if (trailChoice == 1) {
          ...
          System.out.println(
              "You go on a medium difficult trail at the town park. This trail is more intresting that the easy trail and offers more exciting features and views. You return to the trailhead happy with your walk.");
        } else if (trailChoice == 3) {
          System.out.println(
              "You go on a more difficult hike. It offers great views of the surrounding area and is very intresting. You return to your car happy.");
        } else {
          System.out.println("You entered an invalid input. Please enter a number between 1&3.");
          // Tell user to restart and enter number between 1&3
        }
      ...
      // Layer #2
        ...
        if (nationalParkChoice == 1) {
          ...
          System.out.println(
              "You decide to go to the vistor center of the park in order to learn more about it. You spend some time talking to a ranger and going through the displays.");
        } else if (nationalParkChoice == 3) {
          System.out
              .println("You go on a tour of the park with a ranger and see great views of the lake and the mountains.");
        } else {
          System.out.println("You entered an invalid input. Please enter a number between 1&3.");
          // Tell user to restart and enter number between 1&3
        }
      ...
      // Layer #1
        ...
        // Layer #2
          ...
          if (oldWorldWisconsinChoice == 1) {
            ...
            System.out.println(
                "You decide to watch a bread making demonstration. It is very informative and you learn a lot about making bread.");
          } else if (oldWorldWisconsinChoice == 3) {
            System.out.println(
                "You watch a blacksmithing demonstration. It is very informative and you learn a lot about blacksmithing during this time period.");
          } else {
            System.out.println("You entered an invalid input. Please enter a number between 1&3.");
            // Tell user to restart and enter number between 1&3
          }
        ...
        // Layer #2
          ...
          if (elegantFarmerChoice == 1) {
            ...
            System.out.println(
                "You decide to go shopping at the Elegant Farmer store. You spend $50 on apple pies and pumpkin pies.");
          } else {
            System.out.println("You entered an invalid input. Please enter a number between 1&3.");
            // Tell user to restart and enter number between 1&3
          }
